...
package com.jetbrains.plugin.structure.sonar.plugin.api.util
...
object KnownIdePackages {
  ...
  private val idePackages: Set<String> by lazy(KnownIdePackages::readKnownIdePackages)
  ...
  private fun readKnownIdePackages() =
    KnownIdePackages::class.java.classLoader
      .getResourceAsStream("com/jetbrains/plugin/structure/sonar/plugin/api/knownIdePackages.txt")!!
      .bufferedReader()
      .readLines()
      .toSet()
}